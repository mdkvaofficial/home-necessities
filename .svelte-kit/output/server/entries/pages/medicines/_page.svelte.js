import { F as store_get, G as unsubscribe_stores } from "../../../chunks/index.js";
...
function _page($$payload) {
  ...
  if (store_get($$store_subs ??= {}, "$language", language) === "en") {
    $$payload.out += "<!--[-->";
    $$payload.out += `<h1 class="svelte-1gtw8yo">Eziday</h1> <p class="svelte-1gtw8yo">${escape_html(text.en.introduction)}</p> <h6 class="svelte-1gtw8yo">Definition</h6> <p class="svelte-1gtw8yo">${escape_html(text.en.definition)}</p> <h6 class="svelte-1gtw8yo">Basic Usage</h6> <ul class="svelte-1gtw8yo"><li class="svelte-1gtw8yo">${escape_html(text.en.basic_usage.point1)}</li> <li class="svelte-1gtw8yo">${escape_html(text.en.basic_usage.point2)}</li></ul> <h6 class="svelte-1gtw8yo">Advanced Usage</h6> <ul class="svelte-1gtw8yo"><li class="svelte-1gtw8yo">${escape_html(text.en.advanced_usage.point1)}</li> <li class="svelte-1gtw8yo">${escape_html(text.en.advanced_usage.point2)}</li></ul> <h6 class="svelte-1gtw8yo">When Not to Use</h6> <ul class="svelte-1gtw8yo"><li class="svelte-1gtw8yo">${escape_html(text.en.when_not_to_use.point1)}</li> <li class="svelte-1gtw8yo">${escape_html(text.en.when_not_to_use.point2)}</li> <li class="svelte-1gtw8yo">${escape_html(text.en.when_not_to_use.point3)}</li></ul> <h6 class="svelte-1gtw8yo">Side Effects</h6> <ul class="svelte-1gtw8yo"><li class="svelte-1gtw8yo">${escape_html(text.en.side_effects.point1)}</li> <li class="svelte-1gtw8yo">${escape_html(text.en.side_effects.point2)}</li> <li class="svelte-1gtw8yo">${escape_html(text.en.side_effects.point3)}</li> <li class="svelte-1gtw8yo">${escape_html(text.en.side_effects.point4)}</li> <li class="svelte-1gtw8yo">${escape_html(text.en.side_effects.point5)}</li> <li class="svelte-1gtw8yo">${escape_html(text.en.side_effects.point6)}</li></ul> <h6 class="svelte-1gtw8yo">Conclusion</h6> <p class="svelte-1gtw8yo">${escape_html(text.en.conclusion)}</p>`;
  } else {
    $$payload.out += "<!--[!-->";
    $$payload.out += `<h1 class="svelte-1gtw8yo">Eziday</h1> <p class="svelte-1gtw8yo">${escape_html(text.ur.introduction)}</p> <h6 class="svelte-1gtw8yo">Introduction</h6> <p class="svelte-1gtw8yo">${escape_html(text.ur.definition)}</p> <h6 class="svelte-1gtw8yo">Basic Usage</h6> <ul class="svelte-1gtw8yo"><li class="svelte-1gtw8yo">${escape_html(text.ur.basic_usage.point1)}</li> <li class="svelte-1gtw8yo">${escape_html(text.ur.basic_usage.point2)}</li></ul> <h6 class="svelte-1gtw8yo">Advanced Usage</h6> <ul class="svelte-1gtw8yo"><li class="svelte-1gtw8yo">${escape_html(text.ur.advanced_usage.point1)}</li> <li class="svelte-1gtw8yo">${escape_html(text.ur.advanced_usage.point2)}</li></ul> <h6 class="svelte-1gtw8yo">When Not to Use</h6> <ul class="svelte-1gtw8yo"><li class="svelte-1gtw8yo">${escape_html(text.ur.when_not_to_use.point1)}</li> <li class="svelte-1gtw8yo">${escape_html(text.ur.when_not_to_use.point2)}</li> <li class="svelte-1gtw8yo">${escape_html(text.ur.when_not_to_use.point3)}</li></ul> <h6 class="svelte-1gtw8yo">Side Effects</h6> <ul class="svelte-1gtw8yo"><li class="svelte-1gtw8yo">${escape_html(text.ur.side_effects.point1)}</li> <li class="svelte-1gtw8yo">${escape_html(text.ur.side_effects.point2)}</li> <li class="svelte-1gtw8yo">${escape_html(text.ur.side_effects.point3)}</li> <li class="svelte-1gtw8yo">${escape_html(text.ur.side_effects.point4)}</li> <li class="svelte-1gtw8yo">${escape_html(text.ur.side_effects.point5)}</li> <li class="svelte-1gtw8yo">${escape_html(text.ur.side_effects.point6)}</li></ul> <h6 class="svelte-1gtw8yo">Conclusion</h6> <p class="svelte-1gtw8yo">${escape_html(text.ur.conclusion)}</p>`;
  }
  $$payload.out += `<!--]-->`;
